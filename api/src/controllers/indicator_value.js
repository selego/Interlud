    ...
    for (const economicActorAction of economicActorActions) {
      for (const sourceIndicatorValue of sourceIndicatorValues) {
        ...
        payloads.push({
          ...
          display_indicator_excel_id: sourceIndicatorValue.display_indicator_excel_id,
          display_condition_indicator_value: sourceIndicatorValue.display_condition_indicator_value,
