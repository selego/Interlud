          ...
          <div className="flex items-center gap-2 min-h-[38px]">
            {indicatorValue.value_default?.[indicatorValue.indicator_type] == null ? (
              ...
              <>
                ...
                {indicatorValue.indicator_value_unit && typeof indicatorValue.value_default[indicatorValue.indicator_type] === "number" && <span className="text-xs text-[#768776] whitespace-nowrap">{indicatorValue.indicator_value_unit}</span>}
