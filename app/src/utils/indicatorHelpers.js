...
export const fetchConditionValuesMap = async (indicatorValues, { collectivity_id, owner, economic_actor_id }) => {
  ...
  const condParams = { collectivity_id, excel_indicator_ids: [...excelIds] }
  if (owner === "economic_actor") {
    condParams.owner = "economic_actor"
    condParams.economic_actor_id = economic_actor_id
  }
  ...
  if (transitiveIds.size > 0) {
    const transParams = { collectivity_id, excel_indicator_ids: [...transitiveIds] }
    if (owner === "economic_actor") {
      transParams.owner = "economic_actor"
      transParams.economic_actor_id = economic_actor_id
    }
