...
const MultipleSelectInput = ({ value, label = "", placeholder = "", onChange }: MultipleSelectInputProps) => {
    ...
    <div className="w-full">
      ...
      <div className="relative mt-2 w-full">
        <TagsInput
          ...
          renderLayout={(tagComponents: React.ReactNode, inputComponent: React.ReactNode) => (
          ...
          renderTag={({ tag, key }: { tag: string, key: string }) => (
            <span
              key={key}
